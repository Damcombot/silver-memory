...
st.logo("https://images.wallpapersden.com/image/download/cool-circuit-hd-motherboard_bG5naWyUmZqaraWkpJRmbmdlrWZnZWU.jpg", icon_image=main_body_logo)
...
with st.container():
            ...
            with left_column:
                        typewriter("It uses :blue-background[NLP] and :red-background[CV] ",7)
                        typewriter("It can predict the ***presence*** of user ",7)
#camera-roll-test-- 
